  ...
  >
    <section class="hero" @mousemove="handlePointerMove" @click="placeSticker">
      ...
      <header class="hero-header">
        ...
        <p class="lead">一站式管理创建、运行、监控与扩展，让服主把时间花在内容而不是重复操作上。</p>
        <div class="meta">by allenzhang710901</div>
      </header>
...
.meta { margin-top: 8px; color: #93c5fd; font-size: 13px; }
...
.btn.primary { background: linear-gradient(135deg, rgba(56, 189, 248, 0.42), rgba(59, 130, 246, 0.46)); }
...
.panel {
  ...
  border-radius: 14px;
  padding: 16px;
  background: linear-gradient(180deg, rgba(17, 37, 64, 0.82), rgba(9, 18, 33, 0.52));
}
...
.value-card {
  ...
  border-radius: 14px;
  padding: 14px;
  background: linear-gradient(180deg, rgba(17, 37, 64, 0.74), rgba(9, 18, 33, 0.48));
}
...
.customizer {
  ...
  border-radius: 14px;
  padding: 16px;
  background: linear-gradient(180deg, rgba(12, 28, 48, 0.62), rgba(8, 16, 29, 0.4));
}
